    ...
    var TurnBasedGame = {
        ...
        unitSpawn: function (data) {
            ...
            if (unitClass && player) {
				...
				//console.log('barHealthBg',barHealthBg,barHealthBar);
        ...
        unitMove: function (unit, end, callback) {
            ...
            // console.log('unitMove',unit, end, nearestPath);
        },
        ...
        showRange: function(unit) {
            ...
            var hexRange = this.createTiles(vacant, 'hex_select',
                function (hex, i) {
                    var tile = vacant[i];
                    _this.add(hex, _this.hexContainer);
                    //console.log('hex', hex, _this.hexContainer);
		...
		updateRandomGrid: function (unit) {
			console.log('updateRandomGrid',unit );
 			this.clearHexTiles(unit, 'range reach');
		   var _this = this;
		   var vacant = this.hexgrid.tiles;
           var hexRange = this.randomCreateTiles( vacant, 
                function (hex, i) {
                    var tile = vacant[i];
                    _this.add(hex, _this.hexContainer);
                }
        ...
        setUnitActive: function(unit) {
            ...
            //console.log('setUnitActive',unit, hexPlayerSide,hexSelect);
        },
        ...
        unitDamage: function(unit, damage) {
            ...
            wol.each(damageArray, function(damageString, i) {
                ...
                console.log('unitDamage',damageText, frameName);
            });
